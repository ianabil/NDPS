...
class PDFController extends Controller
{
    ...
    public function generate_monthly_report(Request $request){
        ...
        if (!is_dir(base_path().'/temp_files')) 
        {
            mkdir(base_path().'/temp_files', 0777, true);       
        }
        
        if(file_exists(base_path()."/temp_files/ddms_seizures_disposal_report.pdf"))
        {
            unlink(base_path()."/temp_files/ddms_seizures_disposal_report.pdf");
        }
        
        $mpdf->Output(base_path()."/temp_files/ddms_seizures_disposal_report.pdf");
        $mpdf->close();
