                        ...
                        <div class="tab-pane active" id="seizure">
                            <form id="form_seizure">
                                <div class="form-group required row">
                                    ...
                                    <div class="col-sm-3">
                                        <input class="form-control" type="text" id="stakeholder" placeholder="Case No. Initials" autocomplete="off">                                                                                
                                    </div>
                                    <div class="col-sm-2">
...
<script>
	...
	/*If multiple narcotics are seized in a same case after submission of seizure details once :: ENDS*/
		...
		$(document).on("click","#apply",function(){
				...
				if(stakeholder==""){
					swal("Invalid Input","Please Insert Initials of Case No.","error");
					return false;
				}
				else if(case_no==""){
        ...
        /*Fetch list of units on correspondance to the selected narcotic type :: ENDS*/
			...
			/* Fetching Case Details On Other Events Too :: STARTS */
				$(document).on("focusout","#stakeholder", function(){
